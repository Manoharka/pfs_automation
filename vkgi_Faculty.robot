...
Login
    ...
    ${In_Username}=    Read Cell Data By Name    Faculty_Login    B2                 
    # ${In_Password}=    Read Cell Data By Name    Student_Login    C2    
    ${Val_Username}=    Read Cell Data By Name    Faculty_Login    B3        
...
Startclass&virtualclassroom
    Click Element    xpath=//*[@id="app"]/div/div/main/div[2]/div/div[2]/div/div[1]/div/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div
    Sleep    15    
    Click Button    xpath=//*[@id="popup"]/div/div[3]/div[2]/p/button
    Sleep    20    
    Select Window    Ken42 Live Class - 2020-SOC-NCE(CVR)-MD-CLS08-B
                        # Ken42 Online Classroom - CSE - Course I - Offering A Term 1
    Sleep    15   
    Click Element    xpath=/html/body/div[4]/div/div/header/button/span[1]
    Sleep    10
    Element Text Should Be    xpath=//*[@id="app"]/main/section/div[1]/header/div/div[1]/div[2]/h1    2020-SOC-NCE(CVR)-MD-CLS08-B
    Sleep    10
...
verifyclassroom
    ...
    Sleep    10
    Element Text Should Be    xpath=//*[@id="app"]/div/div/main/div[2]/div/div[1]/div/div[1]/h6    2020-SOC-NCE(CVR)-MD-CLS08-B
    Sleep    10    
    
SubmitAttendance
    Select Checkbox    xpath=//*[@id="app"]/div/div/main/div[2]/div/div[2]/div/div[1]/div/div/div/div[4]/div/div[3]/p/label/span[1]/span[1]/input
    Sleep    10
    ...
    Sleep    5
    Click Button    xpath=//*[@id="app"]/div/div/main/div[2]/div/div[2]/div/div[1]/div/div/p/button   
    Sleep    5
    Unselect Checkbox    xpath=//*[@id="app"]/div/div/main/div[2]/div/div[2]/div/div[1]/div/div/div/div[4]/div/div[3]/p/label/span[1]/span[1]/input
